defmodule Beamlens.Domain.Logger do
  @moduledoc """
  Application log monitoring domain.
  ...
  Requires `Beamlens.Domain.Logger.LogStore` to be running. The LogStore
  ...
  This domain captures application log messages and makes them available
