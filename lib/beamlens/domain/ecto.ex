defmodule Beamlens.Domain.Ecto do
  @moduledoc """
  Ecto database monitoring domain.
  ...
  Define a domain module for your Repo:
  ...
  alias Beamlens.Domain.Ecto.Adapters.{Generic, Postgres}
