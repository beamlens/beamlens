defmodule Beamlens.Domain.System do
  @moduledoc """
  OS-level system metrics domain.
  ...
  This domain requires os_mon to be started. Add it to your application's
