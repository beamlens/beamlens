if Code.ensure_loaded?(Tower) do
  defmodule Beamlens.Domain.Exception do
    @moduledoc """
    Application exception monitoring domain.
    ...
    This domain captures exception messages and stacktraces which may contain
